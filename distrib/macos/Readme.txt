...
Please note that the MacOS port is *NOT* maintained by Marcio. For support
specific to the Mac OS X port, please visit

	http://www.floodgap.com/support/macplua/

The port maintainer is Cameron Kaiser.

---

Plua2 Compiler, or plua2c, is a desktop application that compiles Plua source
code into a PRC executable. This version runs on Mac OS X. It is a PowerPC
binary, but should run under Intel without any difficulty. Mac OS X 10.2.8
or the equivalent Darwin kernel is required. Unlike the PC versions, it is
not statically linked as Apple presently deprecates static-linked binaries.
