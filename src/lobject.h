...
#ifdef PALMOS
  long *lineinfo;  /* map from opcodes to source lines */
#else
...
#ifdef PALMOS
  long sizeupvalues;
  long sizek;  /* size of `k' */
  long sizecode;
  long sizelineinfo;
  long sizep;  /* size of `p' */
  long sizelocvars;
  long lineDefined;
#else
  int sizeupvalues;
...
typedef struct LocVar {
  TString *varname;
  long startpc;  /* first point where variable is active */
  long endpc;    /* first point where variable is dead */
} LocVar;
